...
import { getUserName, CurrencyIcon, getPublicIP, calculateServiceTax, isValidEmail } from "@/utils";
      ...
      sidebar={
        <div className="aaravpos-aside">
          <OrderSidebar
            ...
            handleSidebarOpen={handleCloseSidebar}
          />
        </div>
      }
      isConfirm={true}
